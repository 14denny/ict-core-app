                            ...
                            @foreach ($users as $u)
                                <tr class="align-middle">
                                    ...
                                    <td class="text-center">
                                        <button onclick="deleteUser(this)" data-username="{{ $u->username }}"
                                            class="btn btn-sm btn-icon btn-danger"><i class="fa fa-ban"></i></button>
                                        <button onclick="resetPassword(this)" data-username="{{ $u->username }}"
                                            class="btn btn-sm btn-icon btn-warning"><i class="fa fa-rotate"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        (result) => {
                            ...
                            if(result.status){
                                ...
                                tableUser.addRow([
                                    ...
                                    result.data.newUser.username,
                                    result.data.newUser.nama,
                                    result.data.newUser.email,
                                    result.data.newUser.rolename,
                                    `<button onclick="deleteUser(this)" data-username="${result.data.newUser.username}" class="btn btn-sm btn-icon btn-danger">
                                        <i class="fa fa-ban"></i>
                                    </button>
                                    <button onclick="resetPassword(this)" data-username="${result.data.newUser.username}" class="btn btn-sm btn-icon btn-warning">
